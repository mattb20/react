export const sectionDescriptions: Record<string, { details: string }> = {
  ...
  gotchas: {
    details:
      'JavaScript is a very interesting language. One of the most puzzling features being the concept of truthy and falsy. 0 and undefined are falsy where as [] and {} are truthy. How confusing!',
  },
};
